...
import { Box, Paper, Typography, Divider, Toolbar } from "@mui/material";
                ...
                >
                    ...
                    <TripSelector
                        ...
                        disabled={
                            loading ||
                            !filters.country ||
                            availableOptions.trips.length === 0
                        }
                    />
                    ...
                    <AirportSelector
                        ...
                        onChange={(value) =>
                            onFilterChange("departureAirport", value)
                        }
                        disabled={
                            loading ||
                            !filters.trip ||
                            availableOptions.departureAirports.length === 0
                        }
                    />
                    ...
                    >
                        ...
                        <Typography variant="body2">
                            {filters.persons
                                ? t("filter.personsCount", {
                                      count: filters.persons,
                                  })
                                : t("filter.noPersons")}{" "}
                            → {filters.country || t("filter.noCountry")} →{" "}
                            {filters.trip || t("filter.noTrip")} →{" "}
                            {filters.departureAirport || t("filter.noAirport")}
                        </Typography>
                    </Box>
                </Paper>
            </Box>
